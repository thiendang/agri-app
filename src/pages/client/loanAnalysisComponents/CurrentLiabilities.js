...
export default function CurrentLiabilities({classes, data, onRowSelect, ...props}) {
   /**
      ...
      return [
         {
            ...
            Footer: (
               <TypographyFHG color={'primary'} style={{fontWeight: 'bold'}} id={'loan.currentLiabilities.label'} />
            ),
