...
export default function LongTermLiabilities({classes, data, onRowSelect, ...props}) {
   /**
   ...
   const columns = useMemo(() => {
      return [
         {
            Header: <TypographyFHG id={'loan.longTerm.column'} />,
            ...
            Footer: (
               <TypographyFHG
                  ...
                  color={'primary'}
                  id={'loan.longTermLiabilities.label'}
               />
            ),
