 ...
 * @constructor
 */
const MessageFile = ({type, data, read}) => {
            ...
            <Grid container>
               ...
               >
                  <Box display='flex' alignItems='center'>
                     <img src='/images/download.png' alt='download' onClick={handleDownload} />
                     <Button onClick={handleDownload}>
                        <TypographyFHG variant='fs18400' color='text.black'>
                           {data?.media?.substring(data?.media.lastIndexOf('/') + 1, data?.media?.length)}
                        </TypographyFHG>
                     </Button>
                  </Box>
               </Grid>
