...
import EntityCardPdf from './EntityCardPdf';
 ...
 * @constructor
 */
export default function TreeEntityItemPdf({item, itemsKey, labelKey, users}) {
   const childItems = item?.[itemsKey] || [];

   return (
      <View style={styles.frameStyle}>
         <View style={styles.borderStyle}>
            <EntityCardPdf item={item} labelKey={labelKey} users={users} />
         </View>
            ...
            {childItems?.map((child, index) => (
               <View key={index} style={styles.childStyle}>
                  ...
                  <View style={styles.childSpacingStyle}>
                     <TreeEntityItemPdf item={child} itemsKey={itemsKey} labelKey={labelKey} users={users} />
                  </View>
               </View>
            ))}
         </View>
